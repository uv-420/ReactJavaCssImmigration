    ...
    >
      ...
      <div className="mb-2.5 flex w-[70%] flex-col gap-2.5">
        <div className="flex items-center gap-3.5">
          <Img src="images/img_arrow_left.svg" alt="mistakes_to" className="h-[16px]" />
          <Text as="p" className="!text-gray-600">
            {mistakestoavoidtext}
          </Text>
        </div>
        <div className="flex items-center gap-3.5">
          <Img src="images/img_arrow_left.svg" alt="image" className="h-[16px]" />
          <Text as="p" className="self-end !text-gray-600">
            {yourstartuptext}
          </Text>
        </div>
        <div className="flex items-center gap-3.5">
          <Img src="images/img_arrow_left.svg" alt="knew_about" className="h-[16px]" />
          <Text as="p" className="!text-gray-600">
            {knewaboutfontstext}
          </Text>
        </div>
