                ...
                <div className="flex w-full flex-col items-center">
                  ...
                  <div className="relative mt-[-26px] flex w-[43%] justify-between gap-5 md:w-full">
                    <div className="flex py-[7px]">
                      <Img src="images/img_arrow_left.svg" alt="arrowleft" className="h-[10px]" />
                    </div>
                    <div className="flex py-[7px]">
                      <Img src="images/img_arrow_left.svg" alt="arrowleft" className="h-[10px]" />
                    </div>
            ...
            <div className="flex items-start justify-between gap-5 md:flex-col">
              <div className="mt-[5px] flex w-[54%] flex-col items-start gap-[21px] md:w-full">
                ...
                <div className="flex w-[90%] flex-col md:w-full">
                  <Img src="images/img_thumbs_up.svg" alt="thumbsup" className="h-[75px] w-[15%]" />
              ...
              <Img src="images/img_image_blue_gray_100.svg" alt="image" className="h-[591px] w-[41%] md:w-full" />
            </div>
          </div>
