...
export default function Home1Page() {
  ...
  return (
    <>
      <Helmet>
        <title>ReactJavaCssIMMIGRATION</title>
      ...
      <div className="w-full bg-light_green-50 pt-[30px] sm:pt-5">
        <div className="flex flex-col items-center">
          <div className="flex w-[97%] flex-col items-center md:w-full md:p-5">
              ...
              <div className="relative h-[801px] md:h-auto">
                ...
                <div className="absolute bottom-0 left-[17%] top-0 z-[2] my-auto flex h-max w-[40%] flex-col items-start gap-10">
                  ...
                  <Button
                    ...
                    variant="outline"
                    shape="round"
                    rightIcon={<Img src="images/img_save.svg" alt="save" className="h-[14px] w-[14px]" />}
            ...
            <div className="container-xs mt-[120px] flex flex-col gap-[120px] md:gap-[90px] sm:gap-[60px]">
                      ...
                      <div>
                        <div className="flex flex-wrap items-start">
                          ...
                          <Text
                            size="xs"
                            as="p"
                            className="relative mb-[13px] ml-[-3px] rotate-[60deg] !text-[11.48px]"
                          >
                            g
                          </Text>
                          ...
                          <Text
                            size="xs"
                            as="p"
                            className="mt-[18px] h-[12px] w-[12px] rotate-[-40deg] !text-[11.48px]"
                          >
                            d
                          </Text>
                          <Text
                            size="xs"
                            as="p"
                            className="relative mb-[25px] ml-[-3px] rotate-[-50deg] !text-[11.48px]"
                          >
                            w
                          </Text>
                          <Text
                            size="xs"
                            as="p"
                            className="relative mb-[13px] ml-[-2px] rotate-[-60deg] !text-[11.48px]"
                          >
                            i
                          </Text>
                          <Text
                        ...
                        <div className="relative mt-[-4px] flex items-end justify-between gap-5">
                          ...
                          <Img src="images/img_search.svg" alt="search" className="h-[45px] w-[45px]" />
                ...
                <div className="flex w-[49%] flex-col gap-[35px] md:w-full">
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2.5">
                      <Img src="images/img_frame_teal_900.svg" alt="image" className="h-[20px] w-[20px]" />
                    ...
                    <div className="flex flex-col gap-[42px]">
                      ...
                      <div className="flex w-[63%] items-center justify-between gap-5 md:w-full">
                        <Button
                          ...
                          shape="round"
                          rightIcon={
                            <Img src="images/img_arrow_left.svg" alt="arrow_left" className="h-[14px] w-[14px]" />
                          }
                          className="min-w-[157px] gap-2.5 font-semibold sm:px-5"
                        >
                          Read More
              ...
              <div className="flex justify-between gap-5 md:flex-col">
                <Img
                  src="images/img_company_logo_teal_900.svg"
                  alt="companylogo"
                  className="h-[48px] w-[13%] md:w-full"
                />
                <Img
                  src="images/img_company_logo_teal_900_48x108.svg"
                  alt="companylogo"
                  className="h-[48px] w-[8%] md:w-full"
                />
                <Img
                  src="images/img_company_logo_teal_900_48x114.svg"
                  alt="companylogo"
                  className="h-[48px] w-[9%] md:w-full"
                />
                <div className="flex w-[10%] items-end justify-center gap-1.5 md:w-full">
                  <Img src="images/img_lock_teal_900.svg" alt="lock" className="mb-[9px] mt-3 h-[24px]" />
                  <Img src="images/img_settings_teal_900.svg" alt="settings" className="mb-3 h-[17px] w-[78%]" />
                </div>
                <Img
                  src="images/img_company_logo_teal_900_48x144.svg"
                  alt="companylogo"
            ...
            <div className="container-xs mb-1.5 flex flex-col gap-[60px] sm:gap-[30px]">
              <div>
                <div className="flex flex-col gap-2.5">
                  <div className="flex items-center gap-2.5">
                    <Img src="images/img_frame_white_a700.svg" alt="image" className="h-[20px] w-[20px]" />
                ...
                <div>
                  <div className="flex flex-col gap-[7px]">
                    <div className="flex w-[19%] items-start gap-2.5 md:w-full">
                      ...
                      <Img src="images/img_objects_teal_900.svg" alt="objects" className="h-[9px] w-[22%]" />
                    </div>
                    <div className="flex items-center justify-between gap-5 md:flex-col">
                      ...
                      <div className="flex flex-1 flex-col gap-[21px] md:self-stretch">
                        <div className="w-[17%] md:w-full">
                          <div className="flex flex-col items-center justify-center rounded-[40px] bg-light_green-A700 p-[17px]">
                            <Img src="images/img_050_worldwide.svg" alt="050worldwide" className="h-[45px] w-[45px]" />
                          </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between gap-5 md:flex-col">
                      ...
                      <div className="flex gap-5 self-end">
                        <Button
                          ...
                          className="w-[60px]"
                        >
                          <Img src="images/img_close_gray_300.svg" />
                        </Button>
                        <Button
                          onClick={() => {
                            ...
                            <div className="w-full">
                              ...
                              <div className="relative mt-[-75px] rounded-bl-[20px] rounded-br-[20px] rounded-tl-[20px] bg-white-A700 p-[30px] shadow-xs sm:p-5">
                                <div className="flex items-center justify-between gap-5 self-end">
                                  ...
                                  >
                                    <Img src="images/img_arrow_left_teal_900.svg" />
                                  </Button>
                                </div>
                              </div>
                            </div>
          ...
          <div className="mt-[120px] flex h-[900px] w-[94%] items-center justify-center bg-[url(/public/images/img_group_102.svg)] bg-cover bg-no-repeat py-[120px] md:h-auto md:w-full md:p-5 md:py-5">
                    ...
                    <div className="flex w-[33%] flex-col items-center justify-end rounded-[30px] bg-blue_gray-100 p-10 md:w-full sm:p-5">
                      <div className="mt-[334px] flex w-[48%] rotate-[90deg] justify-center rounded-[18px] bg-white-A700 p-1.5 md:w-full">
                        <div className="flex w-full items-center justify-between gap-5">
                          <Img src="images/img_music_teal_900.svg" alt="music" className="h-[16px] w-[16px]" />
                          <Img src="images/img_facebook.svg" alt="facebook" className="h-[22px]" />
                          <Img src="images/img_info.svg" alt="info" className="h-[16px]" />
                          <Img src="images/img_info.svg" alt="info" className="h-[16px] self-start" />
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="relative h-[645px] md:h-auto">
                    ...
                    <React.Fragment key={Math.random()}>
                      <div className="flex gap-[30px] md:flex-col">
                        ...
                        <div className="flex flex-1 flex-col items-start rounded-[20px] bg-light_green-A700 py-[60px] pl-[60px] pr-14 md:self-stretch md:p-5">
                          <Img src="images/img_frame_white_a700_55x72.svg" alt="image" className="h-[55px] w-[12%]" />
              ...
              <div className="absolute bottom-[6%] right-[5%] m-auto flex gap-5">
                <Button
                  ...
                  className="w-[60px]"
                >
                  <Img src="images/img_close_white_a700.svg" />
                </Button>
                <Button
                  color="white_A700"
                  size="4xl"
          ...
          <div className="mt-[120px] flex w-[94%] rounded-[50px] bg-white-A700 md:w-full md:p-5">
            <div className="flex h-[730px] w-full items-center justify-center rounded-[50px] bg-[url(/public/images/img_group_119.png)] bg-cover bg-no-repeat py-[119px] md:h-auto md:py-5">
            ...
            <div className="flex flex-col gap-[60px] sm:gap-[30px]">
              <div className="flex items-center justify-between gap-5 md:flex-col">
                <div className="flex w-[49%] flex-col gap-2.5 md:w-full">
                  <div className="flex items-center gap-2.5">
                    <Img src="images/img_frame_teal_900.svg" alt="image_ten" className="h-[20px] w-[20px]" />
                    <Heading size="xs" as="h2" className="uppercase tracking-[1.40px]">
                      Recent Blogs
                    </Heading>
                  </div>
                ...
                <div className="flex gap-5 self-end">
                  <Button
                    ...
                    className="w-[60px]"
                  >
                    <Img src="images/img_close_teal_900.svg" />
                  </Button>
                  <Button
                    onClick={() => {
                      ...
                      <div className="px-[15px]">
                        <div className="flex flex-col items-center gap-7 rounded-[20px] border border-solid border-gray-300 pb-10 sm:pb-5">
                          ...
                          <div className="w-[80%] md:w-full">
                            <div className="flex justify-between gap-5">
                              <div className="flex items-center gap-[5px]">
                                <Img src="images/img_lock.svg" alt="lock" className="h-[16px]" />
                          ...
                          <div className="ml-10 flex items-center gap-2.5 self-start py-[5px] md:ml-0">
                            ...
                            <Img src="images/img_arrow_left.svg" alt="arrowleft" className="h-[14px] w-[14px]" />
                          </div>
                        </div>
                      </div>
                    </React.Fragment>
