              ...
              <div className="container-xs mb-[31px] flex md:p-5">
                <div className="flex w-[14%] flex-col md:w-full">
                  ...
                  <div className="relative mt-[-9px] flex flex-wrap items-center gap-[15px]">
                    ...
                    <Img src="images/img_save.svg" alt="save" className="h-[16px] self-start" />
                          ...
                          <div className="flex w-[51%] justify-between gap-5 md:w-full sm:flex-col">
                            <div className="flex flex-1 justify-between gap-5 sm:self-stretch">
                              <div className="flex items-center gap-[5px]">
                                <Img src="images/img_lock.svg" alt="by_admin" className="h-[16px]" />
                                <Text as="p" className="!text-gray-900_03">
                                  By admin
                                </Text>
                              </div>
                              <div className="flex flex-1 items-center gap-[5px]">
                                <Img src="images/img_lock.svg" alt="october_192022" className="h-[16px]" />
                                <Text as="p" className="!text-gray-900_03">
                                  October 19, 2022
                                </Text>
                              </div>
                            ...
                            <div className="flex items-center gap-1">
                              <Img src="images/img_lock.svg" alt="comments05one" className="h-[16px] w-[15px]" />
                              <Text as="p" className="!text-gray-900_03">
                                Comments (05)
                              </Text>
                            </div>
                    ...
                    <div className="flex flex-1 flex-col items-start">
                      ...
                      <div className="mt-[26px] flex w-[51%] gap-[30px] md:w-full sm:flex-col">
                        ...
                        <div className="flex flex-1 items-center gap-1 sm:self-stretch">
                          <Img src="images/img_lock.svg" alt="lock" className="h-[16px] w-[15px]" />
                          <Text as="p" className="!text-gray-900_03">
                            Comments (05)
                          </Text>
                        </div>
                        ...
                        suffix={
                          <div className="flex h-[25px] w-[25px] items-center justify-center rounded-[12px]">
                            {searchBarValue1?.length > 0 ? (
                              ...
                              <Img
                                src="images/img_search_teal_900.svg"
                                alt="search"
                          ...
                          <div className="flex w-full items-center gap-[15px]">
                            ...
                            <div className="flex flex-1 flex-col">
                              <div className="flex items-center gap-2.5">
                                <Img src="images/img_checkmark.svg" alt="october_192022" className="h-[16px]" />
                        ...
                        <div className="flex flex-col gap-2.5">
                          <div className="flex gap-[5px]">
                            <Button
                              ...
                              size="md"
                              variant="outline"
                              className="min-w-[131px] rounded-[20px]"
                            >
                              Travel Planning
                            </Button>
                            <Button
                              ...
                              size="md"
                              variant="outline"
                              className="min-w-[127px] rounded-[20px]"
                            >
                              Safety Guides
                            </Button>
                          </div>
                          <div className="flex gap-[5px]">
                            ...
                            <Button
                              ...
                              size="md"
                              variant="outline"
                              className="min-w-[102px] rounded-[20px]"
                            >
                              Wine Tours
                            </Button>
                            <Button
                              ...
                              size="md"
                              variant="outline"
                              className="min-w-[104px] rounded-[20px]"
                            >
                              Travel Pack
                            </Button>
                          </div>
                          <div className="flex items-center gap-[5px]">
                            ...
                            <Button
                              ...
                              size="md"
                              variant="outline"
                              className="min-w-[140px] rounded-[20px]"
                            >
                              Travel Programs
                            </Button>
                          </div>
